...
import { getCustomerReceipt } from '../../../server/services/documentService.js';

/**
 * GET /api/account/receipts/:id
 */
async function handler(req, res) {
  ...
  json(res, 200, success(await getCustomerReceipt(auth.user, id)));
}
